...
class editvmPage extends StatefulWidget {
  const editvmPage({Key? key, required this.id}) : super(key: key);
  final String id;
  @override
  State<editvmPage> createState() => _editvmPageState();

}


  class _editvmPageState extends State<editvmPage> {
...
Future<void> updateProduct() {
    return Vm.doc(widget.id).update({
